              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory">Workshop Name</span> / <span class="w-date">18 Sep. 2025</span>
                    </div>
                  </div>
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory">Web Design</span> / <span class="w-date">18 Sep. 2025</span>
                    </div>
                  </div>
          ...
          <div id="testimonial-mf" class="owl-carousel owl-theme">
           ...
           <div class="testimonial-box">
              <div class="author-test">
                <img src="img/rajes.jpg" alt="" class="rounded-circle b-shadow-a" width="150" height="150">
                <span class="author">SHIV</span>
              </div>
              <div class="content-test">
                <p class="description lead">
                Hi, I’m STILL. I enjoy working on DevOps projects and experimenting with AWS, Docker, Kubernetes, and CI/CD as part of my hands-on learning journey.
                </p>
                ...
                <div class="col-md-6">
                  ...
                  <div class="more-info">
                    ...
                    <ul class="list-ico text-white">
                      <li><span class="ion-ios-location"></span>Thousand Sunny, Grand Line</li>
