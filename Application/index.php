...
<head>
  <meta charset="utf-8">
  <title>Fusion WorkShop</title>
  <meta content="width=device-width, initial-scale=1.0" name="viewport">
  <meta content="" name="keywords">
  <meta content="" name="description">

<!-- FOR ANIME SYLT THOUGHTS -->
...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="#page-top">Fusion WorkShop</a>
  ...
  <!--/ Intro Skew Star /-->
  <div id="home" class="intro route bg-image" style="background-image: url(img/home.jpg);background-size: cover; ">
...
$run = mysqli_query($con, $sql);
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory">NAVARASA</span> / <span class="w-date">18 Sep. 2025</span>
                    </div>
                  </div>
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory">DANSPIRATION</span> / <span class="w-date">07 Sep. 2025</span>
                    </div>
                  </div>
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory">VERVE</span> / <span class="w-date">10 Oct. 2025</span>
                    </div>
                  </div>
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory">DROPBEAT</span> / <span class="w-date">18 Oct. 2025</span>
                    </div>
                  </div>
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory">D-EVOLVE</span> / <span class="w-date">07 Nov. 2025</span>
                    </div>
                  </div>
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory">ZEST</span> / <span class="w-date">20 Nov. 2025</span>
                    </div>
                  </div>
  ...
  <div class="section-counter paralax-mf bg-image" style="background-image: url(img/itachi.jpg);background-size: cover;">
    <div class="overlay-mf"></div>
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="">
            <div class="row">
              <div class="col-md-6">
                    <div class="about-img">
                      <img src="img/Luffy.jpg" class="img-fluid rounded b-shadow-a" alt="">
                    </div>
...
">
  <!-- Always remember your focus,<br>
  Determines your reality,<br> -->
  <span style="color:#ffcc70;">“No matter how hard it is, I’ll keep moving forward.” — Monkey D. Luffy</span>
</h5>
  ...
  <div class="testimonials paralax-mf bg-image" style="background-image: url(img/itachi.jpg)">
      <div class="overlay-mf"></div>
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            <div class="testimonial-box">
              <div class="author-test">
                <img src="img/Ace.jpg" alt="" class="rounded-circle b-shadow-a" width="150" height="150">
                <span class="author">Shiv</span>
              </div>
              <div class="content-test">
                <p class="description lead">
                I enjoy working on DevOps projects and experimenting with cloud technologies like AWS, Docker, and Kubernetes. This project is part of my hands-on learning journey to build, deploy, and automate applications.
                </p>
  ...
  <section class="paralax-mf footer-paralax bg-image  route" style="background-image: url(img/itachi.jpg)">
    <div class="container">
      <div class="row">
        <div class="col-sm-6">
            ...
            <div id="contact">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="more-info">
                    <p class=" text-white lead">
                      Aniv Games headquarter
                     </p>
                    <ul class="list-ico text-white">
                      <li><span class="ion-ios-location"></span>Going Merry, East Blue, ONE PIECE</li>
                      <li><span class="ion-ios-telephone"></span> +919608470701</li>
                      <li><span class="ion-email"></span> Anivgames19@gmail.com</li>
                    </ul>
                  </div>
                  <div class="socials">
                    <ul>
          ...
          <div class="col-sm-12">
            <div class="copyright-box">
              ...
              <div class="credits">
                ...
                Designed and Developed By <a href=https://github.com/gawalishankar>Shiv Gawali </a>
              </div>
            </div>
          </div>
        </div>
